...
logdir = path.expanduser('/home/aitrading/Desktop/GAN_replicates/models')
img_path_root = path.expanduser('/home/aitrading/Desktop/GAN_replicates/img_results')
...
def trainer(model_object, learning_rate=1e-4, 
    ...
    model = model_object(
    	num_noise = num_noise,learning_rate = learning_rate)
